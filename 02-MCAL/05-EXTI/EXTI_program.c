...
/* init of pointer to call back fn for EXTI0  */
static void (* EXTI0_CallBack) (void) = NULL ; // name of pointer to fn : ModuleName_CallBck
...
void EXTI_voidSoftwareTrigger (Copy_u8EXTILine)
{
